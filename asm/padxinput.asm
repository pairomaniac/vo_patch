...
;
; This does not cover the intro movie. The loop has two branches - the test
; at 0x5c5e95 picks a blocking GetMessageA one, which 0x5b14ba selects while
; an FMV plays, over this one - and hooking their common head at 0x5c5e81
; instead was tried and did not help, because that branch only turns over
; when a message arrives and a pad press is not one.
pump:
    pushad
    pushfd
