...
}, art=JAPAN.art, sites=None, annex=ANNEX_BLOBS)    # the rerelease's art
...
FEATURES = [
    ...
    ('nocpucheck', 'Skip processor check',
     ...
     'MMX, Pentium and vendor checks as well.', [
         ...
         (In(JPORIG_MD5, 0x001c3f55), '0f8425000000', '90e925000000'),
         (In(JPORIG_MD5, 0x001c3f84), '0f850a000000', '909090909090')]),
