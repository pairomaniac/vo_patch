...
| **Fix crash on ALT+TAB** | `0x1c616a`, `0x1c6183`, `0x1c61b0`, `0x1c5412` | the activation handler's recreate, resume and idle calls wrapped: no resume without surfaces, the recreate retried until it takes |
