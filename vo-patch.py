...
# The gamepad tables and both dialogs are data, generated by asm/padtables.py
# and asm/dialogs.py from one description each. The pointers between them are
# computed there rather than counted out by hand here.
